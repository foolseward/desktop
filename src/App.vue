...
<script>
import leftSider from './view/components/left-sider'
...
.alert-outer-right{
  border-left: 8px solid #68b185;
}
.alert-outer-wrong{
  border-left: 8px solid #cb6168;
}
.alert-type-icon{
  position: absolute;
  width: 64px;
...
.alert-close{
  color:#a0a0a0;position:absolute;right:10px;bottom:0;height:48px;line-height: 48px;cursor: pointer;
}
.interceptor svg{
  width:240px;
  height:144px;
